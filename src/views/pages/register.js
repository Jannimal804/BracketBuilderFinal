...
function signUpUser(firstName, lastName, beltLevel, weightClass, email, password) {
$.post("/api/signup", {
  firstName: firstName,
  lastName: lastName,
  beltLevel: beltLevel,
   ...
   render() {
      ...
      return (
         <div className="container">
                   <p> Hello {this.state.firstName} {this.state.lastName} {this.state.beltLevel} {this.state.weightClass}
        </p>
